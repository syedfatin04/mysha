    ...
    <footer className="bg-primary text-primary-foreground py-20">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div className="space-y-6">
            <h4 className="font-display text-lg font-bold uppercase tracking-widest">Quick Links</h4>
          ...
          {/* Services */}
          <div className="space-y-6">
            <h4 className="font-display text-lg font-bold uppercase tracking-widest">Services</h4>
            <ul className="space-y-3">
          ...
          {/* Contact Info */}
          <div className="space-y-6">
            <h4 className="font-display text-lg font-bold uppercase tracking-widest">Contact Info</h4>
        ...
        <div className="mt-20 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex space-x-6">
            <Link href="#" className="text-xs opacity-50 hover:opacity-100 uppercase tracking-widest">Privacy Policy</Link>
            <Link href="#" className="text-xs opacity-50 hover:opacity-100 uppercase tracking-widest">Terms & Conditions</Link>
          </div>
        </div>
      </div>
    </footer>
